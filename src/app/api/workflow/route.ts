...
const APPROVAL_PATTERN =
  /\b(human approval|approval gate|manual approval|approve before|review before|approve or reject|sign[- ]?off|verification gate|never publish without(?: human)? approval)\b/i;
  ...
  "tasks": [
    {
      ...
      "requiresHumanApproval": false
        ...
        const call1Text = await generateOpenRouterCompletion(
          call1Prompt,
          call1System,
          true
        );
